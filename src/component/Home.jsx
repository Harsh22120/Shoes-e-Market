                      ...
                      <div class="row p-5">
                          ...
                          <div class="col-lg-6 mb-0 d-flex align-items-center">
                              <div class="text-align-left align-self-center">
                                  <h1 class="h1 text-success"><b>Shoes</b> eCommerce</h1>
        ...
        <section class="container py-5">
          ...
          <div class="row">
              <div class="col-12 col-md-4 p-5 mt-3">
                  ...
                  <p class="text-center">
                      <Link to ="/products" class="btn btn-success">Go Shop</Link></p>
              </div>
              <div class="col-12 col-md-4 p-5 mt-3">
                  ...
                  <p class="text-center"><Link to ="/products" class="btn btn-success">Go Shop</Link></p>
              </div>
              <div class="col-12 col-md-4 p-5 mt-3">
